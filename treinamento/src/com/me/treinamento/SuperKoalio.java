 ...
 *
 */
public class SuperKoalio extends InputAdapter implements ApplicationListener {
	/**
	...
	public void render () {
		// clear the screen
		float i = Gdx.graphics.getDeltaTime() * 10 + Gdx.graphics.getDeltaTime() * 8;
		System.out.println(Gdx.graphics.getDeltaTime());
		Gdx.gl.glClearColor(0.5f + i , 0.4f + i + 0.2f, 0.2f, 1);
	...
	private void updateKoala(float deltaTime) {
		...
		System.out.println(koala.stateTime);
